...
async function list(req, res, _next) {
  ...
  let filtered = listing.filter((eachRes) => eachRes.status !== "finished"); // It filters the reservations to exclude those with a status of 'finished' and returns the filtered list as a JSON response.
  console.log(date);
